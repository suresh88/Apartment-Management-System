      ...
      <div className="max-w-6xl mx-auto text-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-10 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 border">
            ...
            <h3 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">
              130 Cr+
            </h3>
          ...
          <div className="bg-white p-10 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 border">
            ...
            <h3 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-teal-500">
              30 Lakh+
            </h3>
            <p className="text-gray-600 mt-2 font-medium">
          ...
          <div className="bg-white p-10 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 border">
            ...
            <h3 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500">
              2 Lakh+
            </h3>
            <p className="text-gray-600 mt-2 font-medium">
